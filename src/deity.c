...
bool
load_deity_file (char *deityfile)
{
  // char filename[256];
  DEITY_DATA *deity;
  FILE *fp;
...
load_deity ()
{
  ...
  sprintf (deitylist, "%s", DEITY_LIST);
...
void
do_setdeity (CHAR_DATA * ch, char *argument)
{
...
void
do_showdeity (CHAR_DATA * ch, char *argument)
{
  DEITY_DATA *deity;
...
void
do_makedeity (CHAR_DATA * ch, char *argument)
{
  char filename[256];
  DEITY_DATA *deity;
  bool found;
...
void
do_devote (CHAR_DATA * ch, char *argument)
{
...
void
do_deities (CHAR_DATA * ch, char *argument)
{
  DEITY_DATA *deity;
  int count = 0;
...
void
do_supplicate (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  char buf[MAX_STRING_LENGTH];
  int oldfavor;
