/*#################################################################
  ...
  # ------------------------------------------------------------- #
  #     MUDprograms module (based on MOBprogram by N'Atas-ha)     #
  # ------------------------------------------------------------- #
  # Much has been added, including the capability to put a        #
  # "program" on rooms and objects, not to mention many more      #
  # triggers and ifchecks, as well as "script" support.						#    
  # ------------------------------------------------------------- #
  # Error reporting has been changed to specify whether the       #
  # offending program is on a mob, a room or and object, along    #
  # with the vnum.                                                #
  # ------------------------------------------------------------- #
