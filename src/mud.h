...
typedef enum
{
  CLAN_PLAIN, CLAN_VAMPIRE, CLAN_WARRIOR, CLAN_DRUID, CLAN_MAGE, CLAN_CELTIC, CLAN_DEMON, CLAN_ANGEL, CLAN_ARCHER,
  CLAN_THIEF, CLAN_CLERIC, CLAN_PIRATE, CLAN_ASSASSIN, CLAN_UNDEAD, CLAN_CHAOTIC, CLAN_NEUTRAL, CLAN_LAWFUL,
