...
void
do_mpasupress (CHAR_DATA * ch, char *argument)
{
 ...
 */
int
get_color (char *argument)	/* get color code from command string */
{
...
void
do_mpsoundaround (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
...
void
do_mpsoundat (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  char sound[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
...
void
do_mpsound (CHAR_DATA * ch, char *argument)
{
  char sound[MAX_INPUT_LENGTH];
  EXT_BV actflags;
...
void
do_mpmusicaround (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
...
void
do_mpmusic (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  char music[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
...
void
do_mpmusicat (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  char music[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
...
void
do_mpplace (CHAR_DATA * ch, char *argument)
{
  ...
  if (arg2[0] == '\0')
	...
	{
	  send_to_char
	    ("Invalid vnum range, hi vnum lower than/equal to  low vnum.\n\r",
	     ch);
...
void
do_mppardon (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
  ...
  if (!str_cmp (arg2, "litterbug"))
      ...
      if (xIS_SET (victim->act, PLR_LITTERBUG))
	{
	  ...
	  send_to_char ("Your crime of littering has been pardoned./n/r",
			victim);
	}
      return;
    }
...
void
do_mpinvis (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  sh_int level;
...
void
do_mpadvance (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
  int level;
...
do_mptransfer (CHAR_DATA * ch, char *argument)
{
  ...
  for (ListIdx = ChList; ListIdx; ListIdx = ListIdx->next_in_room)
    {
      for (victim = ListIdx->was_in_room->last_person; victim;
	   victim = ChNext)
	{
	  ChNext = victim->prev_in_room;
...
void
do_mpnuisance (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
  char arg1[MAX_STRING_LENGTH];
  struct tm *now_time;
...
void
do_mpunnuisance (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
 ...
 */
void
do_mpbodybag (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
  OBJ_DATA *obj;
...
void
do_mpmorph (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
  MORPH_DATA *morph;
  char arg1[MAX_INPUT_LENGTH];
...
void
do_mpunmorph (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
  char arg[MAX_STRING_LENGTH];
...
void
do_mpechozone (CHAR_DATA * ch, char *argument)	/* Blod, late 97 */
{
  char arg1[MAX_INPUT_LENGTH];
  CHAR_DATA *vch;
  CHAR_DATA *vch_next;
 ...
 */
void
do_mp_practice (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
...
*/
void
do_mpscatter (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_STRING_LENGTH];
  char arg2[MAX_STRING_LENGTH];
  CHAR_DATA *victim;
 ...
 */
void
do_mp_slay (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
 ...
 */
void
do_mp_damage (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  char buf[MAX_STRING_LENGTH];
...
void
do_mp_log (CHAR_DATA * ch, char *argument)
{
  char buf[MAX_STRING_LENGTH];
 ...
 */
void
do_mp_restore (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
 ...
 */
void
do_mpfavor (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
 ...
 */
void
do_mp_open_passage (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  char arg3[MAX_INPUT_LENGTH];
 ...
 */
void
do_mp_fill_in (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  EXIT_DATA *pexit;
 ...
 */
void
do_mp_close_passage (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_INPUT_LENGTH];
  char arg2[MAX_INPUT_LENGTH];
  char arg3[MAX_INPUT_LENGTH];
 ...
 */
void
do_mpnothing (CHAR_DATA * ch, char *argument)
{
  if (!IS_NPC (ch) || ch->desc || IS_AFFECTED (ch, AFF_CHARM))
    {
      send_to_char (_("Huh?\n"), ch);
 ...
 */
void
do_mpdream (CHAR_DATA * ch, char *argument)
{
  char arg1[MAX_STRING_LENGTH];
  CHAR_DATA *vict;
...
void
do_mpapply (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
...
void
do_mpapplyb (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
 ...
 */
void
do_mp_deposit (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_STRING_LENGTH];
  int gold;
#ifdef ENABLE_GOLD_SILVER_COPPER
 ...
 */
void
do_mp_withdraw (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_STRING_LENGTH];
  int gold;
#ifdef ENABLE_GOLD_SILVER_COPPER
...
void
do_mppkset (CHAR_DATA * ch, char *argument)
{
  CHAR_DATA *victim;
  char arg[MAX_STRING_LENGTH];
...
void
do_mpoowner (CHAR_DATA * ch, char *argument)
{
  OBJ_DATA *obj;
...
void
do_mphunt (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
...
void
do_mphate (CHAR_DATA * ch, char *argument)
{
  char arg[MAX_INPUT_LENGTH];
  CHAR_DATA *victim;
