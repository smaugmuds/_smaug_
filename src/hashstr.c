/*
 ...
 [|             /  *********   *        *  *        *   ********    *******   |]
  \\____________\____________________________________________________________//
     ...
     | by Derek Snider for use in SMAUG.					                         |
     ...
     | removed. Make absolutely sure you do not mix use of strdup and      |
     | free with these functions, or nasty stuff will happen!				       |
     | Most occurances of strdup/str_dup should be replaced with           |
     | str_alloc, and any free/DISPOSE used on the same pointer should be  |
     | replaced with str_free.  If a function uses strdup for temporary    |
     | use... it is best if it is left as is.  Just don't get usage mixed  |
     | up between conventions. The hashstr_data size is 8 bytes of         |
     | overhead. Don't be concerned about this as you still save lots of	 |
     | space on duplicate strings.	-Thoric                                |
     |_____________________________________________________________________|
    //                                                                     \\
