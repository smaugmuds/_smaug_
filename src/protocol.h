...
#define MUDLET_PACKAGE "1\nhttp://localhost/SMAUG2.mpackage"
...
#define TELOPT_GMCP                    201 /* This is ATCP version 2 or GMCP */
 ...
 * settings, and automatically renegotiate MSDP/ATCP/GMCP.
 *
 ...
 * be saved.  However MSDP/ATCP/GMCP is handled through scripts, and we don't
 * want to have to save all of the REPORT variables, so it's easier to
 * renegotiate.
 *
 ...
 * will automatically use ATCP/GMCP instead if MSDP is not supported by the
 * client.
 */
...
/* Function: SoundSend
 *
 * Sends the specified sound trigger to the player, using MSDP or ATCP/GMCP if
